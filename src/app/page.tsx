...
<div className="menu-bar">
  ...
  <div
    className="hamburger text-[#ee5225]"
    onClick={() => {
      ...
      <li key={section}>
        <button
          onClick={() => {
            ...
            document.querySelector('.nav-links')?.classList.remove('open'); // 👈 Hides menu after click
          }}
          className="text-white rounded-full hover:text-[#ee5225] font-medium transition"
        >
          {section}
        </button>
      </li>
...
<section id="projects" className="mb-20">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-5 mt-8">
    {filteredProjects.map((project) => (
      <div
        ...
        className="relative group cursor-pointer overflow-hidden shadow-lg transition-transform rounded-2xl duration-300
          hover:scale-[1.03] focus:scale-[1.03] active:scale-[1.03]
      ...
      >
        ...
        <div
          className="absolute inset-x-0 bottom-0 h-[60%] bg-gradient-to-t from-black/80 to-transparent
            opacity-0 group-hover:opacity-100 group-focus:opacity-100 group-active:opacity-100
            transition-opacity duration-500 ease-in-out pointer-events-none z-10"
        />

        <div
          className="absolute bottom-1 left-0 right-0 px-4 pb-3 z-20 opacity-0
  ...
  <div className="w-full overflow-hidden pt-24 pb-4 mb-6">
    <motion.div
      ...
      animate={{ x: ['0%', '-50%'] }} // Only slide one set width
      transition={{ repeat: Infinity, duration: 20, ease: 'linear' }}
    >
      {/* Duplicated once for seamless loop */}
        ...
        <div key={`${logo.alt}-${idx}`} className="flex-shrink-0 mx-10">
          ...
          <footer className="w-full mt-12 bg-transparent">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-y-10 w-full">
              ...
              {/* Right-aligned group: Contact Us, Location, Follow Us */}
...
{selectedProject && (
  ...
  >
    <div
      className="bg-white w-full h-full md:w-[95vw] md:h-[95vh] overflow-y-auto shadow-lg relative rounded-none md:rounded-lg"
      onClick={(e) => e.stopPropagation()}
    >
      {/* Hero Image Section */}
      <div className="relative w-full h-48 md:h-[70vh] bg-black">
        {/* Close Button */}
        <button
      ...
      {/* Info Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 py-8 text-[#58595b]">
        <div>
      ...
      {/* Back Button */}
      <div className="flex justify-start px-4 pb-8 md:px-10">
        <button
          onClick={() => setSelectedProject(null)}
