...
const team: TeamMember[] = [
  { name: 'Abel Tefera', role: 'CEO & Founder', image: '/Image/abela.jpg' },
  { name: 'KETEMA KEBEDE', role: 'Senior Strategic Advisor', image: '/Image/emily.jpg' },
  { name: 'Aklog Tefera', role: 'UI/UX Designer', image: '/team/emily.jpg' },
  { name: 'REKIK MESFIN', role: 'Marketing, Content Creator', image: '/team/emily.jpg' },
  { name: 'Andargachew', role: 'Lead Developer', image: '/Image/Andi.jpg' },
  { name: 'MUFERIHA ', role: 'Copywriter', image: '/team/emily.jpg' },
];
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="relative rounded-3xl bg-black/38 backdrop-blur-1xl text-white flex flex-col justify-between overflow-y-auto overflow-x-hidden"
          ...
          >
            ...
            <div className="text-center mt-8 mb-18">
              <h2 className="text-[42px] sm:text-4xl font-bold mb-4">Our Team</h2>
